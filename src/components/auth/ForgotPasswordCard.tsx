...
import { ArrowLeft, Headphones, Globe, CheckCircle, Mail, AlertCircle } from 'lucide-react';
...
export const ForgotPasswordCard: React.FC<ForgotPasswordCardProps> = ({ onOpenTechSupport }) => {
